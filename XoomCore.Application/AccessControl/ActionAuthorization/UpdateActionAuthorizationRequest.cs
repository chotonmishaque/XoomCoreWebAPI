...
public class UpdateActionAuthorizationRequest
{
...
public class UpdateActionAuthorizationRequestValidator : CustomValidator<UpdateActionAuthorizationRequest>
{
    public UpdateActionAuthorizationRequestValidator()
    {
        RuleFor(x => x.Id)
           .GreaterThan(0)
